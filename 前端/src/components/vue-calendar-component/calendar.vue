...
<template>
  <section class="wh_container">
    <div class="wh_content_all">
      ...
      <div class="btn" v-if="!active">
        <el-button type="success" round :disabled="disabled" @click="signedToday()">今日签到</el-button>
        <p>
          <span class="signed">连续签到<i>{{signedMore}}</i>天</span>
        </p>
      </div>
    </div>
  </section>
...
export default {
  ...
  methods: {
    ...
    signedToday(){
      this.$emit("singedToday",this.toDay)
    },
